...
/*
 * @RequestMapping(value = "/apidirectmargin", method = { RequestMethod.POST,
 * RequestMethod.GET }, consumes = "application/json", produces =
 * "application/json,application/vnd.ms-excel", name =
 * "BASIC COLUMN CHARTS DATA")
 */
/*
 * @RequestMapping(value = "/apidirectmargin", method = { RequestMethod.POST,
 * RequestMethod.GET })
...
@Tag(name = "APIControlDirectMargin", description = "This API Generate Direct Margin Approximation Calculation")
@RestController
@RequestMapping(value = "/apidirectmargin")
@CrossOrigin(origins = "*")
public class APIControlDirectMargin {
	...
	public ResponseEntity<?> getTableData(
		...
		this.beanApproximationMargin=applicationContext.getBean(BeanDirectMargin.class);
	...
	public List<DtoTableRow> returnListByFinancialYear(String m_strPeriodictype,String m_strFromDate,String m_strToDate,Integer n_intAverageCost,int m_strCurrentYear,String m_strQarter,String m_strPageSize,String m_strPageNo,String m_strFilterBy,String m_strPFY,
	    ...
	    @GetMapping("/downloaddirectmargin")
...
class MarginComparatorDescending implements Comparator<DtoTableRow> {
    @Override
    public int compare(DtoTableRow row1, DtoTableRow row2) {
        return Integer.compare(row2.getN_intProfitExpected(), row1.getN_intProfitExpected());
    }
}

class MarginComparatorAscending implements Comparator<DtoTableRow> {
	@Override
    public int compare(DtoTableRow row1, DtoTableRow row2) {
        return Integer.compare(row1.getN_intProfitExpected(), row2.getN_intProfitExpected());
    }
}